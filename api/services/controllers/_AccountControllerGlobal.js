var TAG = '[_AccountControllerGlobal]';
...
function _AccountControllerGlobal(req, options, query_str) {
...
_AccountControllerGlobal.prototype.findAccount = function (cb, result) {
...
_AccountControllerGlobal.prototype.listAccounts = function (cb, result) {
  var ACTION = '[listAccounts]';

  Basil.getAccounts({}, function(err, data) {
    if (err) {err = null;}
    return cb(err, data);
  });
};

_AccountControllerGlobal.prototype.getVirtualNumber = function (cb, result) {
...
_AccountControllerGlobal.prototype.create = function (cb, result) {
  var ACTION = '[create]';
...
_AccountControllerGlobal.prototype.update = function (cb, result) {
  var ACTION = '[update]';
...
module.exports = _AccountControllerGlobal;
